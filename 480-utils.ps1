# LEFT OFF WHERE THERE IS A PROBLEM WITH THE PROGRAM EXITING REGARDLESS OF WHAT IT'S DOING WITH CONNECTVCENTER FUNCTION

$vser = "vcenter.tao.local"
$snshname = "Safe"
$vmhost = "192.168.3.20"
$ds = "datastore2-super10"
Disconnect-VIServer -Server * -Y -ea SilentlyContinue
